...
class DotSpanSide(private val radius: Float, private val color: Int, private val yOffset: Float) : ReplacementSpan() {
    ...
    override fun draw(
        ...
        val circleY = top + (bottom - top) / yOffset // Adjust the Y-offset for dot position.
